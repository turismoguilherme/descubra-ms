-- ============================================
-- SCRIPT DE CORREÇÃO: Passaporte Digital
...
-- Verificar se stamp_themes foi criada
SELECT 
  '✅ Tabela stamp_themes criada' as status,
  COUNT(*) as temas_cadastrados
FROM stamp_themes;

-- Verificar se coluna partner_code existe
SELECT 
  '✅ Coluna partner_code adicionada' as status,
  column_name,
  data_type
FROM information_schema.columns
WHERE table_name = 'route_checkpoints' 
