-- =====================================================
-- SOLUÇÃO COMPLETA PARA PARCEIRO DE TESTE
-- Execute este script no Supabase SQL Editor
-- =====================================================

-- Este script faz TUDO necessário para o parceiro de teste funcionar:
-- 1. Cria/atualiza o parceiro
-- 2. Aprova o parceiro (dar baixa manual)
-- 3. Garante que está ativo
-- 4. Verifica correspondência de emails

-- PRIMEIRO: Adicionar colunas de aprovação se não existirem
DO $$
BEGIN
...
-- AGORA: Processar parceiro de teste
DO $$
DECLARE
...
BEGIN
  ...
  -- Atualizar parceiro (colunas já foram criadas no início do script)
