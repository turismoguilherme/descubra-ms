-- Script para executar a migração do tourist_region_id
-- Execute este arquivo diretamente no banco Supabase
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE '✅ Coluna tourist_region_id adicionada com sucesso!';
  ELSE
    RAISE NOTICE 'ℹ️ Coluna tourist_region_id já existe';
  END IF;
END $$;

-- Atualizar eventos existentes com base na localização
UPDATE events
