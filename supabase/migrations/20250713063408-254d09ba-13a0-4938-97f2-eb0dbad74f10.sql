-- Corrigir a função create_test_users para usar valores válidos de user_type
...
BEGIN
  ...
  LOOP
    ...
    -- Criar perfil do usuário com user_type válido
    INSERT INTO public.user_profiles (
      ...
      END,
      CASE 
        WHEN user_info[3] IN ('admin', 'diretor_estadual', 'gestor_igr', 'gestor_municipal', 'atendente') THEN 'collaborator'
        ELSE 'tourist'
      END,
      now(),
      now()
