...
-- Nota: Este script cria apenas perfis e roles, os usuários devem ser criados através do Supabase Auth UI

-- Primeiro, vamos verificar se já existem usuários de teste
DO $$
DECLARE
...
BEGIN
  ...
  INSERT INTO public.user_profiles (
    ...
    (test_user_id_1, 'Usuário Teste Admin', 'Admin Teste', 'administrator', now(), now()),
    (test_user_id_2, 'Usuário Teste Gestor', 'Gestor Teste', 'collaborator', now(), now()),
    (test_user_id_3, 'Usuário Teste Comum', 'User Teste', 'tourist', now(), now())
