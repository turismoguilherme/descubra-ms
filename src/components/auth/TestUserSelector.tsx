          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-green-800">Logado como: {currentUser.name}</h3>
      ...
      {filteredUsers.length === 0 && (
        <Card>
          <CardContent className="text-center py-8">
            ...
            <p className="text-muted-foreground">Tente ajustar os filtros para encontrar usuários</p>
          </CardContent>
        </Card>
      )}
