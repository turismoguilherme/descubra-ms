      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Painel de controle principal em desenvolvimento. 
            As métricas exibidas são para demonstração.
          </p>
        </CardContent>
      </Card>
    </div>
...
export default MasterDashboardSimple;