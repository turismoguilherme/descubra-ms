  ...
  const handleSend = async () => {
    ...
    try {
      const assistantResponse =
        `Olá! Sou o assistente IA do painel administrativo.\n\n` +
        `Posso orientar sobre o uso do painel: eventos, parceiros, passaporte digital, ` +
        `cartilhas e base de conhecimento do Guatá.\n\n` +
        `💡 Dica: use a Base de Conhecimento em IA → Base de Conhecimento para ensinar novas respostas ao Guatá.`;
  ...
  return (
    <Card className="h-full flex flex-col">
      <CardHeader>
        ...
        <CardDescription>
          Tire dúvidas sobre o uso do painel administrativo
        </CardDescription>
      </CardHeader>
