...
const routeLabels: Record<string, string> = {
  ...
  '/viajar/admin/descubra-ms/platform-settings': 'Conteúdo e opções do site',
  '/viajar/admin/descubra-ms/settings': 'Parceiros (redireciona)',
  '/viajar/admin/financial': 'Financeiro',
  '/viajar/admin/financial/refunds': 'Reembolsos pendentes',
