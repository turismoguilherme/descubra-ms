...
export const PLANS: Record<PlanTier, Plan> = {
  ...
  professional: {
    ...
    features: [
      ...
      { name: 'Guilherme básico', included: true, description: 'Insights semanais' },
  ...
  enterprise: {
    ...
    features: [
      ...
      { name: 'ViaJAR Guilherme Suite completa', included: true },
