/**
 * Respostas temáticas offline — turismo em MS (fallback quando Gemini indisponível)
 */

export interface MSKnowledgeTopic {
  patterns: RegExp[];
  answer: string;
}

export const MS_KNOWLEDGE_TOPICS: MSKnowledgeTopic[] = [
  {
    patterns: [
...
/** Resposta genérica do fallback antigo — não é resposta útil */
