...
// Definir o contexto aqui mesmo
interface OverflowOneAuthContextType {
  user: User | null;
...
const OverflowOneAuthContext = createContext<OverflowOneAuthContextType | undefined>(undefined);
...
export const useOverflowOneAuth = () => {
  const context = useContext(OverflowOneAuthContext);
  
  if (!context) {
    throw new Error("useOverflowOneAuth must be used within an OverflowOneAuthProvider");
  }
