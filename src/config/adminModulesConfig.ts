      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            title: 'Parceiros',
            description:
              'Lista e aprovações, mensalidade e comissão, links Stripe, termos, política de cancelamento e fila de reembolsos',
            helpText:
              'Abas: Lista (cadastros), Taxas e links (valores globais e Stripe), Termos, Cancelamento (percentuais de reembolso ao turista) e Reembolsos (fila de devoluções no cartão). A fila para processar reembolsos no cartão fica na aba Reembolsos, aqui mesmo.',
          },
          {
            id: 'avatars',
            label: 'Avatares',
